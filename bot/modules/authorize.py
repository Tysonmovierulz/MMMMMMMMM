...
addmod_handler = CommandHandler(
    command=BotCommands.AddModCommand,
    callback=addMod,
    filters=CustomFilters.owner_filter,
    run_async=True,
)
removemod_handler = CommandHandler(
    command=BotCommands.RmModCommand,
    callback=removeMod,
    filters=CustomFilters.owner_filter,
    run_async=True,
)
...
addleechlog_alt_handler = CommandHandler(
    command=BotCommands.AddleechlogaltCommand,
    callback=addleechlog_alt,
    filters=CustomFilters.owner_filter | CustomFilters.sudo_user,
    run_async=True,
)
rmleechlog_alt_handler = CommandHandler(
    command=BotCommands.RmleechlogaltCommand,
    callback=rmleechlog_alt,
    filters=CustomFilters.owner_filter | CustomFilters.sudo_user,
    run_async=True,
)
